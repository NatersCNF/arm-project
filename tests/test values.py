...
IndustrialArm = []
IndustrialArm.append(arm.link(r=2, theta=0, a=1, alpha=math.pi/2))
IndustrialArm.append(arm.link(r=0, theta=0, a=5, alpha=0))
IndustrialArm.append(arm.link(r=0, theta=0, a=5, alpha=math.pi/2))

IndustrialArm.append(arm.link(r=1, theta=0, a=0, alpha=-math.pi/2))
IndustrialArm.append(arm.link(r=0, theta=0, a=0, alpha=math.pi/2))
IndustrialArm.append(arm.link(r=1, theta=0, a=0, alpha=0))
