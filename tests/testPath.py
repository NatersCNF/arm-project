...
path1.addP(path.point(b+1, b, -1, math.pi, math.pi, -math.pi))
path1.addP(path.point(b, b, -1, math.pi, 10, math.pi))
...
UnitsPerSecond = 1         # the speed at which the endeffector will move along the path in units per second
